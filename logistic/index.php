...
<?php include 'header.php' ?>			
	        ...
	        <div class="container-fluid">
        		<div class="row column-info block-content">
            		<div class="col-sm-4 col-md-4 col-lg-4 wow fadeInLeft" data-wow-delay="1.5s">
	        ...
	        <div class="big-hr color-1 wow zoomInUp" data-wow-delay="0.3s">
        		<div class="text-left" style="margin-right:40px;">
            		...
            		<p>Vedant Logistics is a well-established supply chain solution's firm majoring in logistics and consultancy.</p>
				</div>
				...
				<div class="row our-services">
            		<div class="col-sm-6 col-md-4 col-lg-4 wow zoomInLeft" data-wow-delay="0.3s">
                		<a href="clearance.php">
	                        ...
	                        <p>Vedant has wide experience in handling Imports and Exports in Kenya, South Sudan and other </p>
	                    </a>
	                </div>
	                ...
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInRight" data-wow-delay="0.3s">
                		<a href="supply-chain-management.php">
                            ...
                            <p> Vedant is capable of assisting reviewing procurement organizations for best practices and </p>
	                    </a>
	                </div>
	            </div>
	        </div>
