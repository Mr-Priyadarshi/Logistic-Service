<?php
    ...
    $sql4="UPDATE `bookingdetails` SET `deliverystatus` = '$deliverystatus ' WHERE `bookingdetails`.`itemid` = $itemid";
    if(mysqli_query($link,$sql4))
    {
        ...
        echo "<script>alert('Delivery Status Update');</script>";
		...
		<body data-scrolling-animations="true">
			<div class="sp-body">
				...
				<div class="bg-image page-title">
					<div class="container-fluid"> <a href="#"><h1>Update Delivery Status</h1></a>
						...
						<div class="card card-4" style="margin-left: auto; margin-right: auto;width: 50%;">
							<div class="card-body">
								<form action="" method="POST">
									...
									<div class="row row-space input-group">
										<h5 style="color: black; text-align: left;">Delivery Status</h5>
										<input class="input--style-4" type="text" name="deliverystatus" required> </div>
									<div class="p-t-15">
