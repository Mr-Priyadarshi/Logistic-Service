		...
		<div class="sp-body">
			<?php include 'header.php' ?>
				<div class="bg-image page-title">
					<div class="container-fluid"> <a href="#"><h1>LOGIN</h1></a>
						<div class="pull-right"> <a href="index.php"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="user_login.php">LOGIN</a> </div>
					</div>
				</div>
        <br>
        <br>
          ...
          <div class="wrapper wrapper--w680">
            <div class="card card-4" style="margin-left: auto; margin-right: auto;width: 50%;">
              <div class="card-body">
				...
				<br>
                <a href="user_register.php" style="text-align: left;">Create an account</a>
              </div>
            </div>
          </div>
