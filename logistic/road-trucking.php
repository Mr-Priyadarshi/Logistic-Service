					...
					<div class="col-sm-9 main-content">
						...
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                ...
                                <p> Vedant ensures that sourcing of goods is done with utmost professionalism taken into consideration to ensure that the correct goods and services are delivered.</p>
								
							</div>
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>Vedant Logistics provides a reasonable yet comprehensive transportation network within East Africa and will be in a position to handle the following:</p>
								<ul class="fa-ul">
                            <li>
