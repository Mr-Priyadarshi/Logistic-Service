...
if(isset($_POST['submit']))
{
    ...
    {
    	$sql1 = "select * from adminaccount where UserID='".$UserID."'";
    	$result=mysqli_query($link,$sql1);
    	$count=mysqli_num_rows($result);
    	if($count==0)
    	{
	        $sql="Insert into adminaccount (FullName,Email,Password,Phone) values ('$FullName','$Email','$Password','$Phone')";
...
<div class="row row-space input-group">
  <label class="label">Re-write Password</label>
   <input class="input--style-4" type="password" name="C_Password">
</div>
