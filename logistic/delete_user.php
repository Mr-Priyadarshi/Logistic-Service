<?php
    ...
    {
    $userid=$_POST['userid'];
    $sql4="DELETE FROM useraccount WHERE user_id= $userid";
		...
		<body data-scrolling-animations="true">
			<div class="sp-body">
				...
				<div class="bg-image page-title">
					<div class="container-fluid"> <a href="#"><h1>Delete User</h1></a>
							...
							<div class="card-body">
								<form action="" method="POST">
									<div class="row row-space input-group">
										<h5 style="color: black; text-align: left;">User Id</h5>
										<input class="input--style-4" type="text" name="userid" required> </div>
									<div class="p-t-15">
