			...
			if(isset($_POST['submit']))
		{
			...
			$price=$_POST['price'];
					...
					$sql="Insert into bookingdetails (itemid,userID,item,source,destination,weight,price) values ('$itemid','$user_id','$itemtype','$from','$to','$weight','$price')";
		...
		<div class="bg-image page-title">
						<div class="container-fluid">
							...
							<div class="pull-right">
								<a href="index.php"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="LOGIN.php">BOOKING</a>
							</div>
						</div>
					</div>
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="row row-space input-group">
												<h5 style="color: black; text-align: left;">Item Type</h5>
												<input class="input--style-4" type="text" name="itemtype" required> </div>
											<div class="row row-space input-group">
												<h5 style="color: black; text-align: left;">From</h5>
												<input class="input--style-4" type="text" name="from" required> </div>
											<div class="row row-space input-group">
											<h5 style="color: black; text-align: left;">To</h5>
												<input class="input--style-4" type="text" required name="to"> </div>
											<div class="row row-space input-group">
